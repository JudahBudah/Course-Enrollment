...
function renderMiniGrid() {
    ...
    container.style.cssText = `display:grid;grid-template-columns:36px repeat(${colCount},1fr);background:var(--off);min-width:${colCount > 1 ? 420 : 160}px;padding-bottom:12px;`;
